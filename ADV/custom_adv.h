...
void fill_adv_packet(CustomAdv_t *pData, uint8_t flags, uint16_t companyID, uint8_t id1, uint8_t id2, int32_t id3, int32_t id4, int16_t temp, char *name);
void start_adv(CustomAdv_t *pData, uint8_t advertising_set_handle);
void update_adv_data(CustomAdv_t *pData, uint8_t advertising_set_handle, uint8_t id1, uint8_t id2, int32_t id3, int32_t id4, int16_t temp);
